...
New ideas can result from combining two previously independent ones; such events can be traced through co-citation analysis~\citep{MarshakovaShaikevich1973,Small1973}. The strength of co-citation, its frequency, can be interpreted as the extent to which a new idea is contemplated and built upon by the community. The initial definition of co-citation, published independently by Marshakova-Shaikevich and Small in 1973, has been followed up by a number of studies that examine novelty from different perspectives of co-citation~\citep{Uzzi2013,Boyack2014,Wang2017,Bradley2020}. 

...
After generating the dataset of 940 million pairs, we applied three initial conditions to filter out possible delayed co-citations: (i) the minimum peak annual co-citation frequency for a co-citation pair should be $>= 20$ (ii) the minimum total frequency of a co-citation pair should be $>= 100$ (iii) a co-citation pair should be derived from two articles that both published later than 1970. Then by applying above, we identified delayed co-citation cases by setting two more conditions: (i) starting from the first possible year, which is the earlier publication year of both articles, the minimum sleeping duration should be 10 years (ii) during sleeping period the average co-citation frequency should be $<= 1$ and in each year the co-citation frequency should be $<= 2$. In order to analyze the delayed co-citation pairs we found statistically, we then calculated the slope and between the co-citation frequency in the first awakening year and the first peak frequency, and also modified the Beauty Coefficient ~\citep{Ke2015}, which was designed to measure kinetics in single publications, to be useful to the case of co-cited pairs ~\citep{devarakonda_2020}. 


In order to answer the question delayed co-citations are derived from Sleeping Beauty publications, we examined all single publications for delayed co-citations we found by applying van Raan's criteria ~\cite{Raan2019}. We slightly modified van Raan's criteria since he's focusing on investigate the number of Sleeping Beauties found for any sleeping time, during-sleep intensity and awakening citation-intensity. He investigated Sleeping Beauties with sleeping period = 5, 10, 15, 20, 25, and 30 years with a focus on the Sleeping Beauties with sleeping period = 5 and 10 years. However, in our case, we considered 10 years as the minimum sleeping period, and needed to get the exact sleeping period for each co-citation pair in order to avoid overlap between the Sleeping Beautie with ‘multiple’ sleeping times. Thus, we modified van Raan's criteria to apply on single publications as: (i) the length of the sleep in years after publication should be $>= 10$ (ii) the depth of sleep in terms of the citation rate during the sleeping period should be $<= 1$ (iii) the awakening period in years after the sleeping period should be $= 5$ (iv) the awakening citation-intensity in terms of the citation rate during the awakening period should be $>= 5$. We also calculated the Beauty Coefficient ~\citep{Ke2015} for all single publications, and compared it with van Raan's parameter-based approach.
